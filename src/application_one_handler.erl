...
processRequest(<<"PUT">>, _, AppId, Req) ->
    ...
    case Encrypt of
        '\n' ->
            {_, AppData} = database:updateAppDBAppId(
                binary:bin_to_list(AppId),
                Name,
                Description,
                OwnedTopics,
                SubscribedTopics,
...
% %% Internal functions
buildResponse(Data) ->
    {_, Id, Name, Description, ApiKeys, Ownedtopics, SubscribedTopics, CreatedOn, Filters, Encrypt,
